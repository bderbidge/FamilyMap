...
//string urlSegments[] = exchange.getRequestURI().tostring().split("/");
//url.endsWith("/event")
                ...
                if (exchange.getRequestMethod().toLowerCase().equals("get")) {
                    ...
                    if (reqHeaders.containsKey("Authorization")) {
                        ...
                        if (path.equals("/person/")) {
                            ...
                            peopleResponse = personService.GetPeople(request);

                            if (peopleResponse.getPeople().size() < 1) {

                                purposeMessage.setMessage("Failed to get all People");
                                ...
                                String json = gson.toJson(peopleResponse);
                                OutputStream respBody = exchange.getResponseBody();
                                writeString(json, respBody);
                            ...
                            response = personService.Get(request);
                            ...
                            if (response != null) {
                                ...
                                purposeMessage.setMessage("The Person ID was not associated with the user");
