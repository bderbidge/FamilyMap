...
/**
 * Created by brandonderbidge on 5/29/17.
 */
...
// From now on, the right way of moving from bytes to utf-8 characters:
                ...
                request = gson.fromJson(buf.toString(), LoadRequest.class);



                purposeMessage = loadService.Post(request);
                ...
                if (purposeMessage.getMessage().equals("Unable to load file")) {
