...
// From now on, the right way of moving from bytes to utf-8 characters:
                ...
                isr.close();
                Gson gson = new Gson();
                RegisterRequest registerRequest = gson.fromJson(buf.toString(), RegisterRequest.class);

                RegisterService registerService = new RegisterService();

                RegisterLoginResponse response = new RegisterLoginResponse();

                if(registerRequest.validRegisterInput() == true) {

                    try {
                        response = registerService.Post(registerRequest);
                    ...
                    if (response == null) {
                        ...
                        purposeMessage.setMessage("Failed to Register User");
                    ...
                    purposeMessage.setMessage("Failed to Register User because the " +
                                                "input was invalid.");
